"""Device and precision configuration for the JAX-backed 3D solver.
...
before importing other `_3d` modules (state_3d, grid_3d, ...) if you can
...
reference solutions (analytical_sb_gaussian_3d, the 1D/2D solvers, etc.) used
...
`_3d` module below is written against `jax.numpy` directly (no separate
