...
%%
figure(2)
semilogy(1:maxIter,outs_admm.residual_primal_diff)

figure(3)
semilogy(1:maxIter,outs_admm.residual_aux_diff)

figure(4)
semilogy(1:maxIter,outs_admm.residual_dual_diff)


% rho_tilde = outs_admm.rho_tilde;