...
% Step Size
% Following Fang et al. "Generalized ADMM": need tau/gamma > ||A^T A||_2
% For interpolation operators: ||A||_2 ≈ 1, so ||A^T A||_2 ≈ 1
% Original: tau = gamma/0.99 gave tau/gamma = 1.01 (too close to boundary!)
% Need more margin for good convergence
gamma = 10;
tau   = 1.1*gamma;   % tau/gamma = 1.5 > 1 (50% margin for faster convergence)
maxIter = 5000;
...
maxIter_ref = 100000;       % Number of iterations for reference solution
...
if compute_reference
    ...
    [rho_star, mx_star, outs_ref] = ot1d_admm(rho0, rho1, opts_ref);

    % Save reference solution
    save(refsoln_filename, 'rho_star', 'mx_star', 'outs_ref', ...
         'gamma', 'tau', 'nx', 'nt', 'test_case', 'rho0', 'rho1');
